...
//        copier.copy(deviceDto,device,null);
            ...
            if (deviceDto.getName() != null){
                device.setName(new String(deviceDto.getName().getBytes(),"utf-8"));
            }
            if (deviceDto.getLocation() != null) {
                device.setLocation(new String(deviceDto.getLocation().getBytes(),"utf-8"));
            }
            ...
            if (deviceDto.getDescription() != null) {
                device.setDescription(new String(deviceDto.getDescription().getBytes(),"utf-8"));
            }

            device.setCreaterId(deviceDto.getCreaterId());
            device.setCreateTime(deviceDto.getCreateTime());
            if (deviceDto.getCreaterName() != null) {
                device.setCreaterName(new String(deviceDto.getCreaterName().getBytes(),"utf-8"));
            }
